...
If you want, I can:
- create a shorter printable handout `handout.pdf`,
- add a `lab-instructions.md` with step-by-step tasks for each role, or
- commit this README and open a PR for review.
